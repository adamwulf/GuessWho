...
- App target: add helper as a target **dependency**; Copy Files build phase → `Contents/MacOS`. Runtime location via `Bundle.main.url(forAuxiliaryExecutable:)` (Muse's approach).
